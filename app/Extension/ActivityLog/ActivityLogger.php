...
namespace App\Extension\ActivityLogger;
...
class ActivityLogger
{
    ...
    public function log(string $description, string $type)
    {
        ...
        $activity->type = $type;
        $activity->type_id = ActivityType::where('activity_type', $type)->value('id');
