...
//        }
    ...
    {
        $this->app->bind('command.activitylog:clean', \App\Extension\ActivityLogger\CleanActivitylogCommand::class);

        $this->commands([
            'command.activitylog:clean',
        ]);

        $this->app->bind(\App\Extension\ActivityLogger\ActivityLogger::class);

        $this->app->singleton(\App\Extension\ActivityLogger\ActivityLogStatus::class);
